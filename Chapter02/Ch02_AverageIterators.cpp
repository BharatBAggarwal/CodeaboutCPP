// Ch02_AverageIterators.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	// use vector iterator member functions to calculate average
	for (auto num = numbers.begin();  // num points to current element
		 num != numbers.end();
		 ++num)
	{
		if (*num >= 10 && *num <= 20)
