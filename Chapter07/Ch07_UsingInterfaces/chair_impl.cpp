...
IChair& Chair_Impl::setColor(ChairProperties::colors aColor)
{
	acolor = aColor;
	return *this;
}
...
IChair& Chair_Impl::setStyle(ChairProperties::styles aStyle)
{
	astyle = aStyle;
	return *this;
}
...
IChair& Chair_Impl::setCapacity(double limit)
{
	maxWeight = limit;
	return *this;
}
